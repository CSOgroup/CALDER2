...
| **genome**                | One of 'hg19', 'hg38', 'mm9', 'mm10', NULL (default). These compartments will be used as reference compartments for optimized bin_size selection. If `genome = others`, a `feature_track` should be provided (see below) and no optimized bin_size selection will be performed 
