...
CALDER works on contact matrices compatable with that generated by Juicer tools (https://github.com/aidenlab/juicer), either a .hic file, or three-column `dump` table as generated by the juicer dump (or straw) command (https://github.com/aidenlab/juicer/wiki/Data-Extraction):	
